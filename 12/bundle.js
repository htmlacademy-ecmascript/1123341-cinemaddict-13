...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: allComments, ages, allEmojies, moviesTitles, genres, descriptions, SortType, UpdatePopup, UpdatedVersion, FilterType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UpdatedVersion", function() { return UpdatedVersion; });
...
/* harmony import */ var _presenter_filter_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./presenter/filter.js */ "./src/presenter/filter.js");
/* harmony import */ var _model_cards_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./model/cards.js */ "./src/model/cards.js");
/* harmony import */ var _model_filter_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./model/filter.js */ "./src/model/filter.js");
/* harmony import */ var _mock_card_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./mock/card.js */ "./src/mock/card.js");
/* harmony import */ var _utils_view_tools_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utils/view-tools.js */ "./src/utils/view-tools.js");
...
const cards = new Array(COMMON_CARD_COUNT).fill().map(_mock_card_js__WEBPACK_IMPORTED_MODULE_6__["generateCard"]);
...
const innerMainPresenter = new _presenter_main_inside_js__WEBPACK_IMPORTED_MODULE_2__["default"](siteMainElement, filterModel, cardsModel);

Object(_utils_view_tools_js__WEBPACK_IMPORTED_MODULE_7__["render"])(siteHeaderElement, new _view_user_rank_js__WEBPACK_IMPORTED_MODULE_0__["default"]());
Object(_utils_view_tools_js__WEBPACK_IMPORTED_MODULE_7__["render"])(siteMainElement, new _view_menu_js__WEBPACK_IMPORTED_MODULE_1__["default"]());
const mainNavigation = siteMainElement.querySelector(`.main-navigation`);

const filterPresenter = new _presenter_filter_js__WEBPACK_IMPORTED_MODULE_3__["default"](mainNavigation, filterModel, cardsModel);
...
/* harmony import */ var _utils_project_tools_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/project-tools.js */ "./src/utils/project-tools.js");
...
const generateComments = () => {
  return new Array(Object(_utils_common_tools_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(0, _const__WEBPACK_IMPORTED_MODULE_3__["allComments"].length - 1))
    .fill()
    .map((it, index) => {
      return _const__WEBPACK_IMPORTED_MODULE_3__["allComments"][index];
    });
};
...
const generateAgeLimits = () => {
  const randomIndex = Object(_utils_common_tools_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(0, _const__WEBPACK_IMPORTED_MODULE_3__["ages"].length - 1);
  return _const__WEBPACK_IMPORTED_MODULE_3__["ages"][randomIndex];
};

const generateTitle = () => {
  const randomIndex = Object(_utils_common_tools_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(0, _const__WEBPACK_IMPORTED_MODULE_3__["moviesTitles"].length - 1);
  return _const__WEBPACK_IMPORTED_MODULE_3__["moviesTitles"][randomIndex];
};

const generateGenres = () => {
  const titles = new Set();
  for (let i = 0; i < Object(_utils_common_tools_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(1, 5); i++) {
    titles.add(_const__WEBPACK_IMPORTED_MODULE_3__["genres"][Object(_utils_common_tools_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(0, _const__WEBPACK_IMPORTED_MODULE_3__["genres"].length - 1)]);
  }
...
const generateDescription = () => {
  ...
  for (let i = 0; i < Object(_utils_common_tools_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(1, 5); i++) {
    sentences.add(_const__WEBPACK_IMPORTED_MODULE_3__["descriptions"][Object(_utils_common_tools_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(0, _const__WEBPACK_IMPORTED_MODULE_3__["descriptions"].length - 1)]);
  }
...
const generateCard = () => {
  ...
  return {
    ...
    releaseDate: Object(_utils_project_tools_js__WEBPACK_IMPORTED_MODULE_2__["generateDate"])(),
    duration: Object(_utils_project_tools_js__WEBPACK_IMPORTED_MODULE_2__["generateDuration"])(), // это файл dayjs
...
class Cards extends _utils_observer_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  setCards(cards) {
    ...
    this._cardsGroup.rated = cards.slice().sort(_utils_project_tools__WEBPACK_IMPORTED_MODULE_1__["compareRating"]);
    this._cardsGroup.commented = cards.slice().sort(_utils_project_tools__WEBPACK_IMPORTED_MODULE_1__["compareCommentsCount"]);
  }
...
/* harmony import */ var _utils_view_tools__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/view-tools */ "./src/utils/view-tools.js");
...
class Filter {
  ...
  init() {
    ...
    this._filterComponent = new _view_filter__WEBPACK_IMPORTED_MODULE_0__["default"](this._getFilters(), this._currentFilter);
    this._filterComponent.setFilterTypeChangeHandler(this._handleFilterTypeChange);

    if (prevFilterComponent === null) {
      Object(_utils_view_tools__WEBPACK_IMPORTED_MODULE_1__["render"])(this._filterContainer, this._filterComponent, _utils_view_tools__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].AFTERBEGIN);
      return;
    }

    Object(_utils_view_tools__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._filterComponent, prevFilterComponent);
    Object(_utils_view_tools__WEBPACK_IMPORTED_MODULE_1__["removeExemplar"])(prevFilterComponent);
  }
  ...
  _handleFilterTypeChange(filterType) {
    ...
    this._filterModel.setFilter(_const_js__WEBPACK_IMPORTED_MODULE_3__["UpdatedVersion"].MAJOR, filterType);
  }
  ...
  _getFilters() {
    ...
    return [
      {
        idName: _const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].ALL,
        title: `All Movies`,
        count: _utils_filter_js__WEBPACK_IMPORTED_MODULE_2__["filterCapacity"][_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].ALL](cards.main).length
      },
      {
        idName: _const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].WATCHLIST,
        title: `Watchlist`,
        count: _utils_filter_js__WEBPACK_IMPORTED_MODULE_2__["filterCapacity"][_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].WATCHLIST](cards.main).length
      },
      {
        idName: _const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].HISTORY,
        title: `History`,
        count: _utils_filter_js__WEBPACK_IMPORTED_MODULE_2__["filterCapacity"][_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].HISTORY](cards.main).length
      },
      {
        idName: _const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].FAVORITES,
        title: `Favorites`,
        count: _utils_filter_js__WEBPACK_IMPORTED_MODULE_2__["filterCapacity"][_const_js__WEBPACK_IMPORTED_MODULE_3__["FilterType"].FAVORITES](cards.main).length
      }
    ];
  }
}
...
/* harmony import */ var _view_movies_all_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../view/movies-all.js */ "./src/view/movies-all.js");
...
/* harmony import */ var _movie_edit__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./movie-edit */ "./src/presenter/movie-edit.js");
...
class InnerMain {
  constructor(mainContainer, filterModel, cardsModel) {
    ...
    this._noMoviesComponent = new _view_no_movies__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._showMoreButtonComponent = null;
    this._containerOfLists = new _view_movies_all_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
    ...
    this._checkedSortType = _const_js__WEBPACK_IMPORTED_MODULE_2__["SortType"].DEFAULT;
    ...
    this._cardEditPresenter = new _movie_edit__WEBPACK_IMPORTED_MODULE_9__["default"](this._handleCardDataChange);
  }
  ...
  _getSortedCards() {
    ...
    const filtredCards = _utils_filter_js__WEBPACK_IMPORTED_MODULE_3__["filterCapacity"][filterType](cardsGroup.main);

    switch (this._checkedSortType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_2__["SortType"].RATING:
        return Object.assign({}, cardsGroup, {main: filtredCards.sort(_utils_project_tools__WEBPACK_IMPORTED_MODULE_1__["compareRating"])});
      case _const_js__WEBPACK_IMPORTED_MODULE_2__["SortType"].MOST_COMMENTED:
        return Object.assign({}, cardsGroup, {main: filtredCards.sort(_utils_project_tools__WEBPACK_IMPORTED_MODULE_1__["compareCommentsCount"])});
      case _const_js__WEBPACK_IMPORTED_MODULE_2__["SortType"].DATE:
        return Object.assign({}, cardsGroup, {main: filtredCards.sort(_utils_project_tools__WEBPACK_IMPORTED_MODULE_1__["compareDate"])});
    }
  ...
  _handleCardDataChange(updateType, updatedVersion, updatedCard) {
    ...
    switch (updateType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_2__["UpdatePopup"].OTHER:
        this._cardsModel = `KOKOKOKO`;
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_2__["UpdatePopup"].POPUP_AT_ALL:
  ...
  _handleSomeWhatRerender(updateType, updatedCard) {
    ...
    switch (updateType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_2__["UpdatedVersion"].PATCH:
        this._cardEditPresenter.createTotally(updatedCard);
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_2__["UpdatedVersion"].MINOR:
        ...
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_2__["UpdatedVersion"].MAJOR:
  ...
  _clearInsideMain({resetRenderedCardsCount = false, resetSortType = false}) {
    ...
    Object(_utils_view_tools__WEBPACK_IMPORTED_MODULE_0__["removeExemplar"])(this._sortComponent);
    Object(_utils_view_tools__WEBPACK_IMPORTED_MODULE_0__["removeExemplar"])(this._noMoviesComponent);
    Object(_utils_view_tools__WEBPACK_IMPORTED_MODULE_0__["removeExemplar"])(this._showMoreButtonComponent);
  ...
  _renderInnerMain() {
    if (this._getSortedCards().main.length === 0) {
      Object(_utils_view_tools__WEBPACK_IMPORTED_MODULE_0__["render"])(this._mainContainer, this._noMoviesComponent);
      return;
    }

    this._renderSort();
    Object(_utils_view_tools__WEBPACK_IMPORTED_MODULE_0__["render"])(this._mainContainer, this._containerOfLists);
  ...
  _renderSort() {
    ...
    this._sortComponent = new _view_sorting_js__WEBPACK_IMPORTED_MODULE_5__["default"](this._checkedSortType);
    this._sortComponent.setSortTypeChangeHandler(this._handleStartSorting);
    Object(_utils_view_tools__WEBPACK_IMPORTED_MODULE_0__["render"])(this._mainContainer, this._sortComponent);
  }

  _renderCard(container, card) {
    const cardPresenter = new _movie_card__WEBPACK_IMPORTED_MODULE_8__["default"](container, this._handleCardDataChange);
  ...
  _renderShowMoreButton() {
    ...
    this._showMoreButtonComponent = new _view_show_more_js__WEBPACK_IMPORTED_MODULE_7__["default"]();
...
class CardPresenter {
  ...
  createTotally(card) {
    ...
    this._cardComponent = new _view_movie_card_js__WEBPACK_IMPORTED_MODULE_1__["default"](this._card);
  ...
  _handleCardClick() {
    this._cardDataChange(
        _const_js__WEBPACK_IMPORTED_MODULE_2__["UpdatePopup"].POPUP_AT_ALL,
        _const_js__WEBPACK_IMPORTED_MODULE_2__["UpdatedVersion"].PATCH,
        Object.assign(
            {},
            this._card
        )
  ...
  _handleWillWatchClick() {
    this._cardDataChange(
        _const_js__WEBPACK_IMPORTED_MODULE_2__["UpdatePopup"].POPUP_AT_ALL,
        _const_js__WEBPACK_IMPORTED_MODULE_2__["UpdatedVersion"].MINOR,
        Object.assign(
            {},
            this._card,
...
/* harmony import */ var _view_movie_edit_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/movie-edit.js */ "./src/view/movie-edit.js");
/* harmony import */ var _utils_view_tools_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/view-tools.js */ "./src/utils/view-tools.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
...
class MovieEdit {
  ...
  createTotally(card) {
    ...
    this._cardEditComponent = new _view_movie_edit_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._card);
    ...
    Object(_utils_view_tools_js__WEBPACK_IMPORTED_MODULE_1__["removeExemplar"])(oldEdit);
    Object(_utils_view_tools_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._cardEditContainer, this._cardEditComponent);
  ...
  _handleCloseClick() {
    ...
    Object(_utils_view_tools_js__WEBPACK_IMPORTED_MODULE_1__["removeExemplar"])(cardEdit);
...
/*!*****************************!*\
  !*** ./src/utils/filter.js ***!
  \*****************************/
/*! exports provided: filterCapacity */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "filterCapacity", function() { return filterCapacity; });
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../const */ "./src/const.js");


const filterCapacity = {
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].ALL]: (cards) => cards,
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].WATCHLIST]: (cards) => cards.filter((card) => card.watchPlan),
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].HISTORY]: (cards) => cards.filter((card) => card.hasWatched),
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].FAVORITES]: (cards) => cards.filter((card) => card.isFavorite),
};
...
/*!************************************!*\
  !*** ./src/utils/project-tools.js ***!
  \************************************/
/*! exports provided: generateDuration, generateDate, generateRecordDay, compareDate, compareRating, compareCommentsCount */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var dayjs_plugin_objectSupport__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! dayjs/plugin/objectSupport */ "./node_modules/dayjs/plugin/objectSupport.js");
/* harmony import */ var dayjs_plugin_objectSupport__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(dayjs_plugin_objectSupport__WEBPACK_IMPORTED_MODULE_3__);
...
dayjs__WEBPACK_IMPORTED_MODULE_1___default.a.extend(dayjs_plugin_relativeTime__WEBPACK_IMPORTED_MODULE_4___default.a);
dayjs__WEBPACK_IMPORTED_MODULE_1___default.a.extend(dayjs_plugin_duration__WEBPACK_IMPORTED_MODULE_2___default.a);
dayjs__WEBPACK_IMPORTED_MODULE_1___default.a.extend(dayjs_plugin_objectSupport__WEBPACK_IMPORTED_MODULE_3___default.a);

const generateDuration = (asMinutes = Object(_common_tools_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(80, 150)) => {
  const minutes = dayjs__WEBPACK_IMPORTED_MODULE_1___default.a.duration(asMinutes, `minutes`).minutes();
  const hours = dayjs__WEBPACK_IMPORTED_MODULE_1___default.a.duration(asMinutes, `minutes`).hours();
  return dayjs__WEBPACK_IMPORTED_MODULE_1___default()({hour: hours, minute: minutes}).format(`H[h] mm[m]`);
};

const generateDate = () => {
  const milliseconds = Object(_common_tools_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(315522000000, 1577739600000);
...
/* harmony import */ var _abstract_smart_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./abstract-smart.js */ "./src/view/abstract-smart.js");
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../const */ "./src/const.js");
  ...
  return new Array(count)
    ...
    .map((_comment, index) => {
      return `<li class="film-details__comment">
        ...
        <div>
          <p class="film-details__comment-text">${he__WEBPACK_IMPORTED_MODULE_1___default.a.encode(comments[index].text)}</p>
...
const createMovieEditTemplate = (card = {}) => {
  ...
  const emojies = createEmojiesTemplate(_const__WEBPACK_IMPORTED_MODULE_3__["allEmojies"]);
...
class MovieEdit extends _abstract_smart_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
...
const createSortTemplate = (checkedSortType) => {
  const isDefaultActive = _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT === checkedSortType ? `sort__button--active` : ``;
  const isDateActive = _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DATE === checkedSortType ? `sort__button--active` : ``;
  const isRateActive = _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].RATING === checkedSortType ? `sort__button--active` : ``;

  return `<ul class="sort">
    <li><a href="#" class="sort__button ${isDefaultActive}" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT}">Sort by default</a></li>
    <li><a href="#" class="sort__button ${isDateActive}" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DATE}">Sort by date</a></li>
    <li><a href="#" class="sort__button ${isRateActive}" data-sort-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].RATING}">Sort by rating</a></li>
  </ul>`;
};
