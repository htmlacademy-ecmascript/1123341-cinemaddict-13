...
/* harmony import */ var _view_movie_edit_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./view/movie-edit.js */ "./src/view/movie-edit.js");
...
/* harmony import */ var _mock_filter_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./mock/filter.js */ "./src/mock/filter.js");
/* harmony import */ var _utils_view_tools_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./utils/view-tools.js */ "./src/utils/view-tools.js");
...
const cards = new Array(COMMON_CARD_COUNT).fill().map(_mock_card_js__WEBPACK_IMPORTED_MODULE_8__["generateCard"]);
const filters = Object(_mock_filter_js__WEBPACK_IMPORTED_MODULE_9__["generateFilter"])(cards);

const body = document.querySelector(`body`);
const siteHeaderElement = body.querySelector(`.header`);
const siteMainElement = body.querySelector(`.main`);

Object(_utils_view_tools_js__WEBPACK_IMPORTED_MODULE_10__["render"])(siteHeaderElement, new _view_user_rank_js__WEBPACK_IMPORTED_MODULE_0__["default"]());
Object(_utils_view_tools_js__WEBPACK_IMPORTED_MODULE_10__["render"])(siteMainElement, new _view_menu_js__WEBPACK_IMPORTED_MODULE_1__["default"](filters));
const cardEditComponent = new _view_movie_edit_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
renderBoard(cards);


function renderBoard(boardCards) {
  if (boardCards.length === 0) {
    Object(_utils_view_tools_js__WEBPACK_IMPORTED_MODULE_10__["render"])(siteMainElement, new _view_no_movies_js__WEBPACK_IMPORTED_MODULE_4__["default"]());
    return;
  }

  Object(_utils_view_tools_js__WEBPACK_IMPORTED_MODULE_10__["render"])(siteMainElement, new _view_sorting_js__WEBPACK_IMPORTED_MODULE_2__["default"]());
  const films = new _view_movies_all_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
  Object(_utils_view_tools_js__WEBPACK_IMPORTED_MODULE_10__["render"])(siteMainElement, films);
  ...
  if (boardCards.length > CARD_COUNT_STEP) {
    ...
    const showMoreButton = new _view_show_more_js__WEBPACK_IMPORTED_MODULE_7__["default"]();
    Object(_utils_view_tools_js__WEBPACK_IMPORTED_MODULE_10__["render"])(filmsLists[0], showMoreButton);
    ...
    showMoreButton.setClickHandler(() => {
      ...
      if (renderedCardsCount >= boardCards.length) {
        Object(_utils_view_tools_js__WEBPACK_IMPORTED_MODULE_10__["removeExemplar"])(showMoreButton);
      }
    });
  }
}
...
function renderCard(container, card) {
  const cardComponent = new _view_movie_card_js__WEBPACK_IMPORTED_MODULE_5__["default"](card);
  Object(_utils_view_tools_js__WEBPACK_IMPORTED_MODULE_10__["render"])(container, cardComponent);

  const renderPopup = () => {
    cardEditComponent.currentCard = card;
    Object(_utils_view_tools_js__WEBPACK_IMPORTED_MODULE_10__["render"])(body, cardEditComponent);
  ...
  const deletePopup = () => {
    Object(_utils_view_tools_js__WEBPACK_IMPORTED_MODULE_10__["removeExemplar"])(cardEditComponent);
...
/* harmony import */ var _utils_common_tools_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/common-tools.js */ "./src/utils/common-tools.js");
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../const */ "./src/const.js");



const generateRating = () => {
  const integer = Object(_utils_common_tools_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(1, 10);
  const fractional = Object(_utils_common_tools_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, 9);

  return `${integer}.${fractional}`;
};

const generateDuration = () => {
  const duration = Object(_utils_common_tools_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(80, 150);
...
const generateAgeLimits = () => {
  const randomIndex = Object(_utils_common_tools_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, _const__WEBPACK_IMPORTED_MODULE_1__["ages"].length - 1);
  return _const__WEBPACK_IMPORTED_MODULE_1__["ages"][randomIndex];
};

const generateTitle = () => {
  const randomIndex = Object(_utils_common_tools_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, _const__WEBPACK_IMPORTED_MODULE_1__["moviesTitles"].length - 1);
  return _const__WEBPACK_IMPORTED_MODULE_1__["moviesTitles"][randomIndex];
};

const generateGenres = () => {
  const titles = new Set();
  for (let i = 0; i < Object(_utils_common_tools_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(1, 5); i++) {
    titles.add(_const__WEBPACK_IMPORTED_MODULE_1__["genres"][Object(_utils_common_tools_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, _const__WEBPACK_IMPORTED_MODULE_1__["genres"].length - 1)]);
  }
...
const generateDescription = () => {
  ...
  for (let i = 0; i < Object(_utils_common_tools_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(1, 5); i++) {
    sentences.add(_const__WEBPACK_IMPORTED_MODULE_1__["descriptions"][Object(_utils_common_tools_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, _const__WEBPACK_IMPORTED_MODULE_1__["descriptions"].length - 1)]);
  }
...
const generateDate = () => {
  const milliseconds = Object(_utils_common_tools_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(315522000000, 1577739600000);
...
const generateCard = () => {
  ...
  return {
    ...
    commentsSum: Object(_utils_common_tools_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, 5),
    watchPlan: Boolean(Object(_utils_common_tools_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, 1)),
    hasWatched: Boolean(Object(_utils_common_tools_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, 1)),
    isFavorite: Boolean(Object(_utils_common_tools_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, 1)),
...
/*!************************************!*\
  !*** ./src/utils/project-tools.js ***!
  \************************************/
/*! exports provided: generateRecordDay */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class MovieEdit extends _abstract_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor() {
    super();
    this._card = null;
    this._clickHandler = this._clickHandler.bind(this);
